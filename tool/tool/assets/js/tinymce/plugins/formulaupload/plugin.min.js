			...
			ed.addCommand('mceFormulaUpload', function(e,args,f) {
				...
				<div class="formulaUploadContainer mce-container mce-panel mce-window">\
                        <div class="formulaUploadContainerInner">\
							...
							<div class="mce-container toolbarContainer container">\
								<div id="toolbar"></div>\
							</div>\
							<div class="formulapreviewCon">\
								<div class="mce-container formulaTextContainer stdContainer stcontainer" hidefocus="1" tabindex="-1">\
										<div class="mce-window-head">\
											<div class="mce-title">Enter Formula</div>\
										</div>\
									<div class="mce-container-body">\
										<textarea name="formula" id="formulaText" class="textareacontainer"></textarea>\
									</div>\
								</div>\
								<div class="previewCon stcontainer">\
